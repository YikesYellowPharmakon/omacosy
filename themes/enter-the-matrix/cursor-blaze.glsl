// Cursor blaze trail from KroneCorylus/ghostty-shader-playground (MIT).
// TRAIL_COLOR is the body, TRAIL_COLOR_ACCENT is the hot edge.
// theme-pack rewrites those two lines per omacosy theme.
...
const vec4 TRAIL_COLOR = vec4(0.6588, 0.7451, 0.3529, 1.0);
const vec4 TRAIL_COLOR_ACCENT = vec4(0.4824, 0.6824, 0.3059, 1.0);
